...
# Check and convert columns to numeric, handling errors
...
# Drop rows with NaN values in the columns used for grouping
group_df = new_df[['sector', 'price', 'price_per_sqft', 'built_up_area', 'latitude', 'longitude']].dropna()
group_df = group_df.groupby('sector').mean()
